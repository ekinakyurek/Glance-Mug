...
class WebSearch:
    ...
    def __init__(self, api_key="AIzaSyDoTp6UicPtIH_JVy-cFwoebTEp9-rRHYE") :
    ...
    def search_word(self, phrase, limit=1) :
        ...
        query_string = "/v1/entities:search?languages=tr&query=" + quote(phrase) + "&key=" + self.api_key + "&limit=1&indent=True"
        ...
        if isSucceed:
            ...
            if score is not None:
                if index + 1 < len(self.words) :
                    ...
                    self.iterasyon(result, score, index + 1, self.words[index])
                else:
    ...
    def iterasyon(self, result, score, index, phrase) :
        ...
        if isSucceed :
            ...
            if score2 is not None and score2 >= score :
                ...
                self.root_iterasyon(result, score, index, phrase)
        else :
    ...
    def root_iterasyon(self,result, score, index, phrase) :
        ...
        if isSucceed:
            ...
            if score2 is not None and score2 >= score :
                ...
                self.matching(result, score, index, phrase)
        else:
    ...
    def matching(self, result, score, index, phrase):
        ...
        elif result.description != undefined:
