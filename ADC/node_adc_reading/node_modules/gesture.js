...
// if(current == 2) console.log("device:" + current + ":" + average);
			if (!self.waiting_for_click_multiple[current]){
				...
				if((current == 2 || current == 1) && result.equation[0] > 0.00065 && result.equation[2] > 0.992  && average < 0.99) {
					self.event.emit("swipe-up,"+ current.toString(), result.equation[0]);
					//console.log("swipe up")
					//console.log("slope: " + result.equation[0]);
					//console.log("correlation: " + result.equation[2]);
				}else if((current == 2 || current == 1) && result.equation[0] < -0.00065 && result.equation[2] < -0.992 && average < 0.99){
					self.event.emit("swipe-down,"+current.toString(), result.equation[0]);
					//console.log("swipe down")
					//console.log("slope: " + result.equation[0]);
					//console.log("correlation: " + result.equation[2]
					// );
 				}else if(current==0 && result.equation[0] > 0.0005 && result.equation[2] > 0.97 && average < 0.99){
					 self.event.emit("swipe-up,"+ current.toString(), result.equation[0]);
                                        //console.log("swipe up")
                                        //console.log("slope: " + result.equation[0]);
                                        //console.log("correlation: " + result.equation[2]);
				 	...
				 	self.event.emit("swipe-down,"+current.toString(), result.equation[0]);
                                        ...
                                        //console.log("slope: " + result.equation[0]);
                                        //console.log("correlation: " + result.equation[2]
				}else if((current == 2) && (result.equation[2] > 0.85 || result.equation[2]<-0.85) && (average > 0.98)){
